...
// MY STUDIO — Studio Layout
// PURPOSE: Main app shell with sidebar navigation for all 16 modules + library + settings
...
// --- Feature flags (Phase 1: only AVATAR is enabled) ---
            ...
            return (
              <div key={group.key} className="mb-6">
                ...
                <ul className="space-y-1">
                  {items.map((item) => {
                    const enabled = FEATURE_FLAGS[item.key] ?? false;
